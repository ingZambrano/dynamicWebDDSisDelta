...
CREATE TABLE `cat_dispositivos` (
  ...
  `DESC_DISPOSITIVO` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ID_DISPOSITIVO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Catalogo de dispositivos';
...
INSERT INTO `cat_dispositivos` VALUES ('A0001','Refrigerador','Refrigerador tipo americano');
